...
plot_interaction_effect(df_original, "Driver education", "Crash experience",  target_variable, "Original", "original_interaction_education_crash")
plot_interaction_effect(df_perceived, "Driver education", "Crash experience",  target_variable, "Perceived","perceived_interaction_education_crash")

# Count for Original Data and Percieved Data
count_original = count_combinations(df_original, "Driver education", "Crash experience", "Original")
count_perceived = count_combinations(df_perceived, "Driver education" , "Crash experience", "Perceived")
