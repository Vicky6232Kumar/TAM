...
from parametric_tests import ind_t_test, two_way_mixed_anova
from non_parametric_tests import kruskal_wallis, wilcoxon_test, mann_whitney_u_test
...
if is_normal_perceived:
    ind_t_test(df_perceived,categorical_variable,  target_variable, "Perceived")
else:
    mann_whitney_u_test(df_perceived, categorical_variable,  target_variable, "Perceived")
