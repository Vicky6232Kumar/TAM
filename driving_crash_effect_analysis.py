...
plot_interaction_effect(df_original, "Driving experience in years", "Crash experience",  target_variable, "Original", "original_interaction_driving_crash")
plot_interaction_effect(df_perceived, "Driving experience in years", "Crash experience",  target_variable, "Perceived","perceived_interaction_driving_crash")

# Count for Original Data and Percieved Data
count_original = count_combinations(df_original, "Driving experience in years", "Crash experience", "Original")
count_perceived = count_combinations(df_perceived, "Driving experience in years" , "Crash experience", "Perceived")
